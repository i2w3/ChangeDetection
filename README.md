# TODO
- [x] 实现 [SE2020](https://github.com/LiheYoung/SenseEarth2020-ChangeDetection) 的 ONNX 格式转换和 TensorRT::fp16/32 引擎导出，并完成推理流程
...
|:----------------:|:--------:|:----:|:----:|
| pspnet_hrnet_w18 | trt:fp16 |0.6940|0.164s|
| pspnet_hrnet_w40 | trt:fp16 |0.6893|0.189s|
